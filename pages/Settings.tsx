...
export const Settings: React.FC = () => {
    ...
    return (
        <div className="max-w-2xl mx-auto min-h-screen pb-24 md:pb-12 animate-fade-in">
            <AnimatePresence mode="wait">
                {!subView ? (
                    ...
                    >
                        ...
                        <div className="bg-white dark:bg-surface-dark rounded-[32px] shadow-sm border border-slate-200 dark:border-neutral-800 overflow-hidden divide-y divide-slate-100 dark:divide-neutral-800/50 mx-4 sm:mx-0">
                            ...
                            <MenuRow 
                                ...
                                sub="Alterar senha e proteção de conta"
                            ...
                            <MenuRow 
                                ...
                                sub={`Versão ${APP_VERSION} e Novidades`}
                            ...
                            <MenuRow 
                                ...
                                sub="Sair de todos os dispositivos"
                                onClick={() => {
                                    logout();
                                    navigate('/');
                                }}
                        ...
                        <div className="flex justify-center pt-4">
                            <p className="text-[10px] font-black text-slate-300 dark:text-neutral-700 uppercase tracking-[0.2em]">
                                {APP_NAME} © 2026
                            </p>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        {subView === 'security' && (
                            <>
                                <SubViewHeader title="Segurança" onBack={() => setSubView(null)} />
                                <div className="p-6 space-y-6">
                        ...
                        {subView === 'appearance' && (
                            <>
                                <SubViewHeader title="Aparência" onBack={() => setSubView(null)} />
                                <div className="p-6 space-y-6">
                        ...
                        {subView === 'notifications' && (
                            <>
                                <SubViewHeader title="Notificações" onBack={() => setSubView(null)} />
                        ...
                        {subView === 'about' && (
                            <>
                                <SubViewHeader title="Sobre o Sistema" onBack={() => setSubView(null)} />
