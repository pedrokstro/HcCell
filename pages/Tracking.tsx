...
export const Tracking: React.FC = () => {
    ...
    const getStatusInfo = (status: string) => {
        switch (status) {
            ...
            case OrderStatus.WAITING_WITHDRAWAL: return { icon: AlertTriangle, color: 'text-orange-600', bg: 'bg-orange-100', text: 'Seu aparelho está pronto e aguarda retirada na loja.' };
